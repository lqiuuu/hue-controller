...
// global variables:
let address, url, userid, command, data, request, command1, mode;
...
//   let command1Field = document.getElementsByClassName("command1");
//   command1 = command1Field.value;

  document.getElementsByClassName("command1").addEventListener("click", async function() {
  command1 = this.getAttribute("data-mode"); // 获取 data-mode 的值
  });

  let dataField = document.getElementById("data");
  data = dataField.value;

  url = 'http://' + address + '/api/' + userid + command1;
